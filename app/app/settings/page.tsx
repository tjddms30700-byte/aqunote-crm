      ...
      {tab === "policy" && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 md:p-7">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {/* ✅ v3.40.0: 회원권 · 이용 프로그램 통합 관리 */}
            <Link href="/settings/catalog" className="group bg-gradient-to-br from-purple-50 to-emerald-50 border-2 border-purple-200 rounded-xl p-4 hover:shadow-md hover:border-emerald-400 transition">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-emerald-500 flex items-center justify-center text-white text-2xl mb-2 shadow">🎫</div>
              <div className="text-sm font-bold text-purple-900">회원권 · 이용 프로그램 관리</div>
              <div className="text-[11px] text-purple-700 mt-1">💳 회원권 상품 + 🎯 이용 프로그램 통합</div>
              <div className="text-[10px] text-purple-500 mt-1">→ 결제·계약서 자동 바인딩</div>
              <div className="mt-2 text-[10px] text-gray-500 group-hover:text-emerald-600">수중·지상·디바이스케어 카테고리별 관리</div>
            </Link>
